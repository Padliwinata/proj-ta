...
class TestFraudDetectionStaff(unittest.TestCase):
    def test_staff_get_report_unauthorized(self):
        response = client.get(
            f"/api/report",
        )
    ...
    def test_staff_get_report_forbidden_access(self):
    ...
    def test_staff_get_report_success(self):
        login_response = client.post(
            "/api/auth",
    ...
    def test_staff_get_report_by_key_forbidden_access(self):
            login_response = client.post(
                "/api/auth",
                data={"username": "reviewer", "password": "reviewer"}
            )
    ...
    def test_staff_get_report_by_key_success(self):
            login_response = client.post(
                "/api/auth",
                data={"username": "staff_perusahaan", "password": "password_baru"}
            )
    ...
    def test_staff_insert_report_unprocessable_entity(self):
        login_response = client.post(
            "/api/auth",
            data={"username": "staff_perusahaan", "password": "password_baru"}
        )
    ...
    def test_staff_insert_report_forbidden_access(self):
        login_response = client.post(
            "/api/auth",
            data={"username": "reviewer", "password": "reviewer"}
        )
    ...
    def test_staff_insert_report_success(self):
        login_response = client.post(
            "/api/auth",
            data={"username": "staff_perusahaan", "password": "password_baru"}
        )
