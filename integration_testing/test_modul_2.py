...
@pytest.mark.order(2)
def test_staff_get_fraud_assessments_history(access_token_staff):
    response = client.get(
        "/api/assessments",
...
@pytest.mark.order(3)
def test_staff_get_assessment_active(access_token_staff):
    response = client.get(
        "/api/assessment",
        headers={"Authorization": f"Bearer {access_token_staff}"},
        params={
...
@pytest.mark.order(4)
def test_staff_get_assessment_active_not_found(access_token_staff):
    response = client.get(
        "/api/assessment",
        headers={"Authorization": f"Bearer {access_token_staff}"},
        params={
...
@pytest.mark.order(5)
def test_staff_fill_assessment_point_already_exist(access_token_staff):
...
@pytest.mark.order(6)
def test_staff_fill_assessment_invalid_sub_bab(access_token_staff):
    response = client.post(
        "/api/point",
        headers={"Authorization": f"Bearer {access_token_staff}"},
        params={
...
@pytest.mark.order(7)
def test_staff_fill_assessment_success(access_token_staff):
    response = client.post(
        "/api/point",
        headers={"Authorization": f"Bearer {access_token_staff}"},
        params={
...
@pytest.mark.order(8)
def test_staff_update_assessment(access_token_staff):
...
@pytest.mark.order(9)
def test_staff_submit_assessment(access_token_staff):
    response = client.post(
        "/api/selesai",
        headers={"Authorization": f"Bearer {access_token_staff}"},
        params={
